# SkillSprout API - JSON Test Data for Manual Testing (FIXED)

This document provides corrected JSON payloads with the proper field names for all API endpoints.
...
## 📖 Lesson Management Endpoints (FIXED - Using content_text)

### 9. Create Lesson for Course (FIXED)
```json
POST /api/lessons/courses/1
{
    "title": "Introduction to Python Variables and Data Types",
    "content_text": "In this lesson, we'll explore Python variables and basic data types including strings, integers, floats, and booleans.",
    "video_url": "https://example.com/videos/python-intro.mp4",
    "order_index": 1
}
```

### 10. Create Lesson - Advanced Topic (FIXED)
```json
POST /api/lessons/courses/1
{
    "title": "Object-Oriented Programming in Python",
    "content_text": "Learn about classes, objects, inheritance, and polymorphism in Python with practical examples.",
    "video_url": "https://example.com/videos/python-oop.mp4",
    "order_index": 10
}
```

### 11. Create Lesson - Web Development (FIXED)
```json
POST /api/lessons/courses/2
{
    "title": "React Components and JSX",
    "content_text": "Understanding React components, JSX syntax, and component composition.",
    "video_url": "https://example.com/videos/react-components.mp4",
    "order_index": 1
}
```

### 12. Create Lesson - Data Science (FIXED)
```json
POST /api/lessons/courses/3
{
    "title": "Introduction to Pandas and DataFrames",
    "content_text": "Learn how to work with data using Pandas library, create DataFrames, and perform basic data operations.",
    "video_url": "https://example.com/videos/pandas-intro.mp4",
    "order_index": 1
}
```

### 13. Create Lesson - Machine Learning (FIXED)
```json
POST /api/lessons/courses/3
{
    "title": "Linear Regression Fundamentals",
    "content_text": "Understanding the mathematical foundation of linear regression and how to implement it with scikit-learn.",
    "video_url": "https://example.com/videos/linear-regression.mp4",
    "order_index": 5
}
```
...
### 21. Registration with Duplicate Email
```json
POST /api/users/register
{
...
### 22. Registration with Invalid Email
```json
POST /api/users/register
{
...
### 23. Registration with Missing Fields
```json
POST /api/users/register
{
...
### 25. Create Course with Invalid Price
```json
POST /api/courses/
{
...
### 26. Create Review with Invalid Rating
```json
POST /api/enrollments/1/reviews
{
    "rating": 10,
...
### 27. Create Lesson with Missing Required Fields
```json
POST /api/lessons/courses/1
{
...
### Step 4: Create Lessons (FIXED - Using content_text)
```json
POST /api/lessons/courses/[COURSE_ID]
{
    "title": "Arrow Functions and Template Literals",
    "content_text": "Learn how to write cleaner, more concise code using arrow functions and template literals.",
...
**✅ FIXED: Lesson Creation Field Names**
- **Before**: Used `content` field (causing NOT NULL constraint error)
- **After**: Changed to `content_text` field (matches lesson serializer)

**✅ All lesson creation examples now use the correct `content_text` field name**

This should resolve the database constraint violation you encountered!
