...
def simple_seed_lessons(db_session):
    ...
    try:
        ...
        lessons_data = [
            ...
            (courses.get('Java Tutorial for Beginners'), 'Introduction to Java', 'Welcome to Java programming! In this lesson, you will learn about Java history, its key features, and why it is one of the most popular programming languages worldwide. We will also set up your development environment.', 'https://www.youtube.com/watch?v=YZkyL-f-YXY', 1),
            ...
            (courses.get('Python Full Course for Beginners'), 'Python Syntax and Variables', 'Understand Python simple syntax, variable naming conventions, and basic data types including strings, integers, and floats.', 'https://www.youtube.com/watch?v=H2EJuAcrZYU&t=600s', 2),
            (courses.get('Python Full Course for Beginners'), 'Lists and Dictionaries', 'Master Python most important data structures - lists and dictionaries - and learn how to manipulate collections of data effectively.', 'https://www.youtube.com/watch?v=H2EJuAcrZYU&t=1200s', 3),
